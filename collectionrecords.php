...
?>
    ...
    <section class="hoc container clear"> 
      <div class="sectiontitle">
        <p class="heading underline font-x2" style="margin-left: 26%;"><b>Collected Donations Table</b></p>
      </div>
  ...
  <tbody>
    <?php
    $logged_in_agent = $_SESSION["user_id"];
    $sql_query = "SELECT * FROM `food_post` WHERE `status`=1 AND `collected_agent_id`='$logged_in_agent'";
    ...
    if($rowcount>0){
      ...
      while($row = mysqli_fetch_assoc($result)) {
        ...
        <tr>
          ...
          <td><a href="#view_post_modal" rel="modal:open">View Post</a></td>
        </tr>
        <div id="view_post_modal" class="modal">
